<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('backend/vendors/images/icon_sirta.png')}}">
	<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('backend/vendors/images/icon_sirta.png')}}">
	<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('backend/vendors/images/icon_sirta.png')}}">
